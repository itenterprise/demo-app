...
@interface ITAppBaseDelegate ()

@end

@implementation ITAppBaseDelegate
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    NSDictionary *userDefaultsDefaults = [NSDictionary dictionaryWithObjectsAndKeys:
                                          @"https://demo-mobile.it.ua/ws/webservice.asmx", @"serviceurl",
                                          @"2015.07", @"version",
                                          nil];
...
{
    [[NSUserDefaults standardUserDefaults] setObject:url forKey:@"serviceurl"];
...
void uncaughtExceptionHandler(NSException *exception)
{
    ...
    [[ITApplicationManager sharedManager] sendCrashReport:exception];
}
